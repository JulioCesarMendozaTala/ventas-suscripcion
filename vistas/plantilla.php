<?php 
	...
	/* Seleccionas una variable y presionas CRTL + SHIF + Q 
...
<?php 
	...
	/*SI vienen variables GET llamadas PAGINA*/
	/*si la variable get es igual a "pagina" me vas a incluir el valor de la variable

		Ejemplo: si la variable GEt = a inicio, me vas incluir de la carpeta paginas el archivo inicio.php y asi sucesivamente con los otros archivos
