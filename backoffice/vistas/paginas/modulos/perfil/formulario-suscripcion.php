<div class="col-12 col-md-8">
	...
	<div class="card card-info card-outline">
		...
		<div class="card-body">
			...
			<br>
			<p class="card-text">Al activar su membresía mensual ingresa en nuestro programa de afiliado, el cual podrá generar ingresos extras de forma consecutiva gracias a la red multinivel que puede hacer con nosotros, mas información ingrese a la pagina <a href="plan-compensacion">Plan de compensaciión</a></p>
			...
			<div class="form-group">
				...
				<div>
					<input type="text" class="form-control" id="inputEmail" value="info@academiyoflife.com" readonly>
				</div>
			</div>
			...
			<!--====  label Enlace afiliado  ====-->
			<div class="form-group">
				<label for="inputAfiliado" class="control-label">Enlace de afiliado</label>
				<span>(Compartiendo este enlace podra ganar comiciones, mas información: <a href="plan-compensacion">Plan de compensación</a>)</span>
